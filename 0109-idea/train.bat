...
@REM lr3
@REM call python train.py --model_class_name EcomDFCL_regretNet_rplusc --tau 0.8 --fcd_mode log1p --max_multiplier 1.0 --scheduler raw --clipnorm 5e3 --model_path ./model/EcomDFCL_regretNet_rplusc_wce_2pos_lr3_clip=5e3_log1p_max=1_tau=0.8_sum
@REM call python train.py --model_class_name EcomDFCL_regretNet_rplusc --tau 0.8 --fcd_mode log1p --max_multiplier 1.0 --scheduler raw --clipnorm 100 --model_path ./model/EcomDFCL_regretNet_rplusc_wce_2pos_lr3_clip=100_log1p_max=1_tau=0.8_sum
@REM call python train.py --model_class_name EcomDFCL_regretNet_rplusc --tau 0.8 --fcd_mode log1p --max_multiplier 1.0 --scheduler raw --clipnorm 10 --model_path ./model/EcomDFCL_regretNet_rplusc_wce_2pos_lr3_clip=10_log1p_max=1_tau=0.8_sum



@REM lr5e-5
@REM call python train.py --model_class_name EcomDFCL_regretNet_rplusc --tau 0.8 --fcd_mode log1p --max_multiplier 1.0 --scheduler raw --lr 5e-5 --clipnorm 5e3 --model_path ./model/EcomDFCL_regretNet_rplusc_wce_2pos_lr5e-5_clip=5e3_log1p_max=1_tau=0.8_sum
