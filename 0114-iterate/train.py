...
# from dfcl_regretNet_v1_rplusc import EcomDFCL_regretNet_rplusc, DENSE_FEATURE_NAME, dropout_rate, DropoutScheduler
...
callbacks = [
    ...
    # DropoutScheduler(dropout_rate, start=0.3, end=0.1, warm_epochs=5),  # ===== 新增 =====
]
