...
# 步骤 3: 循环评估每个已保存的模型
model_paths_DFCL = [
    "./model/EcomDFCL_regretNet_rplusc_wce_preddict_2pos_lr4_clip=60_log1p_max=1_tau=1.0",
    "./model/EcomDFCL_regretNet_rplusc_wce_preddict_2pos_lr4_clip=60_log1p_max=1_tau=2.0",

    "./model/EcomDFCL_regretNet_rplusc_wce_preddict_2pos_lr3_clip=60_log1p_max=1_tau=1.0",
    "./model/EcomDFCL_regretNet_rplusc_wce_preddict_2pos_lr3_clip=60_log1p_max=1_tau=2.0",

    "./model/EcomDFCL_regretNet_rplusc_wce_preddict_2pos_lr5e-5_clip=60_log1p_max=1_tau=1.0",
    "./model/EcomDFCL_regretNet_rplusc_wce_preddict_2pos_lr5e-5_clip=60_log1p_max=1_tau=2.0",
]
model_paths_else = [
