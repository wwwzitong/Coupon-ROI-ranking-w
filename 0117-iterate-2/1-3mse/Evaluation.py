...
# 步骤 3: 循环评估每个已保存的模型
model_paths_DFCL = [
    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr4_clip=80_log1p_max=1_tau=0.8",
    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr4_clip=80_log1p_max=1_tau=1.0",
    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr4_clip=80_log1p_max=1_tau=1.5",
    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr4_clip=80_log1p_max=1_tau=2.0",
    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr4_clip=80_log1p_max=1_tau=2.5",

    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr3_clip=80_log1p_max=1_tau=0.8",
    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr3_clip=80_log1p_max=1_tau=1.0",
    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr3_clip=80_log1p_max=1_tau=1.5",
    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr3_clip=80_log1p_max=1_tau=2.0",
    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr3_clip=80_log1p_max=1_tau=2.5",

    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr5e-5_clip=80_log1p_max=1_tau=0.8",
    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr5e-5_clip=80_log1p_max=1_tau=1.0",
    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr5e-5_clip=80_log1p_max=1_tau=1.5",
    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr5e-5_clip=80_log1p_max=1_tau=2.0",
    "./model/EcomDFCL_regretNet_rplusc_mse_2pos_lr5e-5_clip=80_log1p_max=1_tau=2.5",
]
model_paths_else = [
