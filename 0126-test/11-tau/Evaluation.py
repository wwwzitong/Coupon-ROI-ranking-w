...
model_paths_DFCL = [
    ...
    "./model/EcomDFCL_regretNet_tau_mean+ratios_bs4096_lr1e-4_clip=5e3_max=1",
    "./model/EcomDFCL_regretNet_tau_mean+ratios_bs4096_lr5e-4_clip=5e3_max=1",
    "./model/EcomDFCL_regretNet_tau_mean+ratios_bs4096_lr1e-3_clip=5e3_max=1",
    "./model/EcomDFCL_regretNet_tau_mean+ratios_bs4096_lr2e-3_clip=5e3_max=1",
    "./model/EcomDFCL_regretNet_tau_mean+ratios_bs4096_lr5e-5_clip=5e3_max=1",
