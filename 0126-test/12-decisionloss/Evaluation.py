...
model_paths_DFCL = [
    ...
    # "./model/rplusc_wce_LSE_mean_ratios_Nt_bs4096_lr5e-4_clip=5e3_max=3_tau=1.0_p2",
    # "./model/rplusc_wce_LSE_mean_ratios_Nt_bs4096_lr5e-4_clip=5e3_max=2_tau=1.0_p2",
    "./model/rplusc_wce_LSE_mean_ratios_bs4096_lr5e-4_clip=5e3_max=1_tau=1.0_p2",
