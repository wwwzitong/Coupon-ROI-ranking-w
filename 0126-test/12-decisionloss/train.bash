...
python train.py --model_class_name EcomDFCL_regretNet_rplusc --tau 1.0 --scheduler raw --bs 4096 --max_multiplier 1 --lr 5e-4 --clipnorm 5e3 --model_path ./model/rplusc_wce_LSE_mean_ratios_Nt_bs4096_lr5e-4_clip=5e3_max=1_tau=1.0_p2
