...
model_paths_DFCL = [
    ...
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr1e-3_clip=5e3_alpha=100",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr1e-3_clip=5e3_alpha=10",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr1e-3_clip=5e3_alpha=2.5",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr1e-3_clip=5e3_alpha=1.5",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr1e-3_clip=5e3_alpha=1",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr1e-3_clip=5e3_alpha=0.5",

    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr5e-4_clip=5e3_alpha=100",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr5e-4_clip=5e3_alpha=10",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr5e-4_clip=5e3_alpha=2.5",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr5e-4_clip=5e3_alpha=1.5",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr5e-4_clip=5e3_alpha=1",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr5e-4_clip=5e3_alpha=0.5",

    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr1e-4_clip=5e3_alpha=100",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr1e-4_clip=5e3_alpha=10",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr1e-4_clip=5e3_alpha=2.5",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr1e-4_clip=5e3_alpha=1.5",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr1e-4_clip=5e3_alpha=1",
    "./model/EcomDFCL_v3_wce_4ifdl_bs512_step500_lr1e-4_clip=5e3_alpha=0.5",
]
model_paths_else = [
