...
model_paths_DFCL = [
    ...
    # "./model/EcomDFCL_regretNet_rplusc_wce_loss2_bs8192_lr2e-3_clip=5e3_max=0.1_tau=0.5",
    # "./model/EcomDFCL_regretNet_rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.3"

    # "./model/EcomDFCL_regretNet_rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.05_tau=0.5",
    ...
    # "./model/rplusc_nopenalty_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_rho=0.01",
    # "./model/rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_rho=0.01",
    # "./model/rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_rho=0.1",
    # "./model/rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.05_tau=0.5_rho=0.1",
    # "./model/rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.08_tau=0.5_rho=0.01",

    # "./model/rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.08_tau=0.5_rho=0.1"
    # "./model/rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.08_tau=0.5_rho=0.1",
    # "./model/rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_rho=0.1_ratiosum",
    # "./model/rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_rho=0.01_ratiosum",
    # "./model/rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_rho=0.15",
