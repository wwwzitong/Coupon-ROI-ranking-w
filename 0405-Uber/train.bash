...
# python train.py --model_class_name EcomDFCL_v3 --alpha 0.1 --loss_function 3erl --bs 256 --lr 1e-3 --clipnorm 100 --tau 2.5 --batch_sum_mean sum --model_path ./model/EcomDFCL_v3_wce_3erl_bs256_step500_lr1e-3_clip=100_alpha=0.1_tau=2.5
# python train.py --model_class_name EcomDFCL_v3 --alpha 100 --loss_function 4ifdl --bs 256 --lr 1e-3 --clipnorm 100 --batch_sum_mean sum --model_path ./model/EcomDFCL_v3_wce_4ifdl_bs256_step500_lr1e-3_clip=100_alpha=100

# python train.py --model_class_name EcomDFCL_regretNet_rplusc --tau 1.0 --bs 256 --max_multiplier 1.0 --lr 1e-4 --clipnorm 5e3 --model_path ./model/EcomDFCL_regretNet_rplusc_mse_bs256_step500_lr1e-4_clip=5e3_max=1_tau=1.0

# python train.py --model_class_name SLearner --bs 256 --lr 1e-3 --clipnorm 5e3 --model_path ./model/SLearner_mse_mean_bs256_step500_lr1e-3_clip=5e3

# python train.py --model_class_name EcomDFCL_v3 --alpha 10 --loss_function 2pll --bs 256 --lr 1e-3 --clipnorm 5e3 --batch_sum_mean sum --model_path ./model/EcomDFCL_v3_mse_2pll_bs256_step500_lr1e-3_clip=5e3_alpha=10
# python train.py --model_class_name EcomDFCL_v3 --alpha 0.1 --loss_function 3erl --bs 256 --lr 1e-3 --clipnorm 100 --tau 2.5 --batch_sum_mean sum --model_path ./model/EcomDFCL_v3_mse_3erl_bs256_step500_lr1e-3_clip=100_alpha=0.1_tau=2.5
# python train.py --model_class_name EcomDFCL_v3 --alpha 100 --loss_function 4ifdl --bs 256 --lr 1e-3 --clipnorm 100 --batch_sum_mean sum --model_path ./model/EcomDFCL_v3_mse_4ifdl_bs256_step500_lr1e-3_clip=100_alpha=100
