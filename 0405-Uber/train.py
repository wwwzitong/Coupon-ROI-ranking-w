...
config = {
    ...
    'last_model_path': '',
    'train_data': '../data/census1990_train.csv', 
    'val_data': '../data/census1990_val.csv',
    'batch_size': 4096,
    'num_epochs': 50,
...
from ecom_slearner_UScensus import SLearner, DENSE_FEATURE_NAME
...
train_samples = (
    train_samples
    .map(_to_features_labels, num_parallel_calls=tf.data.AUTOTUNE)
    .repeat()   # 每个 epoch 重新从训练集开头取数据
