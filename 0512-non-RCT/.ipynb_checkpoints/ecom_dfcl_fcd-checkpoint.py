...
# statistical_config={ # alpha=2p0
#     'N':4480906,
#     'N1':3801996,
#     'N0':678910
# }
# statistical_config={ # alpha=5p0
#     'N':4468856,
#     'N1':3785687,
#     'N0':683169
# }
statistical_config={ # alpha=1p0 + finalprop
    'N':2527008,
    'N1':1429152,
    'N0':1097856
}
...
class EcomDFCL_v3(tf.keras.Model): # std+ifdl一系列clip、maximum+2pos
    ...
    """
    def __init__(self, alpha=1.2, dense_stats=None, fcd_mode='log1p', loss_function='2pll', tau=1.2, rho=0.1, max_multiplier=1.0, **kwargs):
        super().__init__(**kwargs)
        self.tau = tau
        # self.paid_pos_weight = 99.50/(100-99.50) # alpha=2p0
        # self.cost_pos_weight = 92.32/(100-92.32)
        # self.paid_pos_weight = 99.49/(100-99.49) # alpha=5p0
        # self.cost_pos_weight = 92.07/(100-92.07)
        # self.paid_pos_weight = 99.34/(100-99.34) # alpha=1p0 + finalprop
        # self.cost_pos_weight = 91.03/(100-92.03)
