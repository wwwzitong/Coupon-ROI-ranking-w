...
model_paths_DFCL = [
    ...
    "./model/EcomDFCL_v3_2pll_2pos_lr3_CD_alpha=10.0_clip=5e3",
    "./model/EcomDFCL_v3_2pll_2pos_lr3_CD_alpha=100.0_clip=5e3",
]
model_paths_else = [
    "./model/EcomDFCL_v3_2pll_2pos_lr3_CD_alpha=1.5_clip=5e3",
    "./model/EcomDFCL_v3_2pll_2pos_lr3_CD_alpha=0.1_clip=5e3",
    "./model/EcomDFCL_v3_2pll_2pos_lr3_CD_alpha=0.5_clip=5e3",
    "./model/EcomDFCL_v3_2pll_2pos_lr3_CD_alpha=1.0_clip=5e3",
]
