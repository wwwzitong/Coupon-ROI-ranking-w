...
python train.py --model_class_name EcomDFCL_v3 --alpha 10 --loss_function 2pll --bs 256 --lr 1e-3 --clipnorm 5e3 --model_path ./model/EcomDFCL_v3_wce_2pll_bs256_step500_mean_lr1e-3_clip=5e3_alpha=10
