...
# python train_our.py --seed 42 --model_class_name EcomDFCL_regretNet_rplusc --tau 0.5 --bs 4096 --max_multiplier 0.1 --lr 1e-3 --clipnorm 5e3 --fcd_mode raw --model_path ./model/EcomDFCL_regretNet_rplusc_wce_batchmean_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_raw_run6
...
# python train_our.py --seed 41 --model_class_name EcomDFCL_regretNet_rplusc --tau 0.5 --bs 4096 --max_multiplier 0.1 --lr 1e-3 --clipnorm 5e3 --fcd_mode raw --model_path ./model/EcomDFCL_regretNet_rplusc_wce_batchmean_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_raw_seed41
...
# python train_our.py --seed 43 --model_class_name EcomDFCL_regretNet_rplusc --tau 0.5 --bs 4096 --max_multiplier 0.1 --lr 1e-3 --clipnorm 5e3 --fcd_mode raw --model_path ./model/EcomDFCL_regretNet_rplusc_wce_batchmean_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_raw_seed43
...
# python train_our.py --seed 44 --model_class_name EcomDFCL_regretNet_rplusc --tau 0.5 --bs 4096 --max_multiplier 0.1 --lr 1e-3 --clipnorm 5e3 --fcd_mode raw --model_path ./model/EcomDFCL_regretNet_rplusc_wce_batchmean_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_raw_seed44
...
# python train_our.py --seed 40 --model_class_name EcomDFCL_regretNet_rplusc --tau 0.5 --bs 4096 --max_multiplier 0.1 --lr 1e-3 --clipnorm 5e3 --fcd_mode raw --model_path ./model/EcomDFCL_regretNet_rplusc_wce_batchmean_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_raw_seed40
...
python train_our.py --seed 39 --model_class_name EcomDFCL_regretNet_rplusc --tau 0.5 --bs 4096 --max_multiplier 0.1 --lr 1e-3 --clipnorm 5e3 --fcd_mode raw --model_path ./model/EcomDFCL_regretNet_rplusc_wce_batchmean_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_raw_seed39
