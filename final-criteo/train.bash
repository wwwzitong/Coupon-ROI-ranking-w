...
# python train.py --model_class_name EcomDFCL_v3 --loss_function 3erl --bs 1024 --alldata False --lr 1e-3 --tau 1 --alpha 100 --fcd_mode raw --clipnorm 5e3 --model_path ./model/EcomDFCL_v3_3erl_bs1024_step500_lr1e-3_alpha=100_clip=5e3_tau=1_raw
