...
model_paths_DFCL = [
    ...
    # "./model/SLearner_2pos_lr3_clip=100_run2",

    # "./model/EcomDFCL_v3_2pll_bs1024_step500_lr1e-3_alpha=0.1_clip=5e3_raw_run2",
    # "./model/EcomDFCL_v3_3erl_bs1024_step500_lr1e-3_alpha=100_clip=5e3_tau=3_raw_run2",
    # "./model/EcomDFCL_v3_4ifdl_bs256_step500_lr1e-3_alpha=100_clip=100_log1p_run2",

    # "./model/EcomDFCL_regretNet_rplusc_wce_batchmean_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_raw_run2",

    # "./model/EcomDFCL_v3_2pll_bs1024_step500_lr1e-3_alpha=0.1_clip=5e3_raw_run8",
    # "./model/EcomDFCL_v3_2pll_bs1024_step500_lr1e-3_alpha=0.1_clip=5e3_raw_run9",
    # "./model/EcomDFCL_regretNet_rplusc_wce_batchmean_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_raw_run6",
    ...
    "./model/EcomDFCL_regretNet_rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.08_tau=1.0_log1p",
    "./model/EcomDFCL_regretNet_rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.12_tau=1.0_log1p",
    "./model/EcomDFCL_regretNet_rplusc_wce_loss2_bs4096_lr5e-4_clip=5e3_max=0.1_tau=1.0_log1p",

    "./model/EcomDFCL_regretNet_rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.1_log1p",
    "./model/EcomDFCL_regretNet_rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.3_log1p",
    "./model/EcomDFCL_regretNet_rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.1_tau=0.5_log1p",
    "./model/EcomDFCL_regretNet_rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.1_tau=1.0_log1p",
    "./model/EcomDFCL_regretNet_rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.1_tau=1.2_log1p",
    "./model/EcomDFCL_regretNet_rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.1_tau=1.5_log1p",
    "./model/EcomDFCL_regretNet_rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.1_tau=2.0_log1p",
    "./model/EcomDFCL_regretNet_rplusc_wce_loss2_bs4096_lr1e-3_clip=5e3_max=0.1_tau=2.5_log1p",
