...
config = {
    ...
    'model_path': './model/ecom_DFCL_2pll_feature_2pos_std_tower',
    'last_model_path': '',
...
model.fit(train_samples, validation_data=val_samples, epochs=config['num_epochs'], steps_per_epoch = 300, callbacks=callbacks,verbose=2) # 只在每个 epoch 结束后打印一行日志
